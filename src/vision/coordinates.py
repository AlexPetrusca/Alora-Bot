...
# dx = 37, dy = 37
class Prayer(Enum):
    PROTECT_FROM_MAGIC = CONTROL_PANEL_LEFT + 82, CONTROL_PANEL_TOP + 174
    PROTECT_FROM_MISSILES = CONTROL_PANEL_LEFT + 119, CONTROL_PANEL_TOP + 174
    PROTECT_FROM_MELEE = CONTROL_PANEL_LEFT + 156, CONTROL_PANEL_TOP + 174
    EAGLE_EYE = CONTROL_PANEL_LEFT + 193, CONTROL_PANEL_TOP + 174
    MYSTIC_MIGHT = CONTROL_PANEL_LEFT + 45, CONTROL_PANEL_TOP + 211
    PIETY = CONTROL_PANEL_LEFT + 82, CONTROL_PANEL_TOP + 248
